# Test Chorus Broadband Map
This is a Java/Gradle project. Test auotmation built using Cucumber BDD framework & Selenium WebDriver; browser test implemented for Chrome driver.
